import ServerTableSubsidiary from "@/app/components/subsidiary/ServerTableSubsidiary";
        ...
        <main className=" flex min-h-screen flex-col px-12 bg-gris">
            <div className="grid grid-cols-1 mt-5">
                ...
                <div className="grid grid-cols-8">
                        ...
                        <div className="col-span-4 mt-5 sm:mt-5 md:mt-0 lg:mt-0 xl:mt-0 flex justify-start px-5">
                            <Link className="static bg-primary hover:bg-hover-primary text-white font-semibold py-3 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 flex items-center" href="/administrator/subsidiary/create" type="button">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-5">
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xl font-semibold text-gray-800">Total sucursales</h2>
                        <FiHome className="text-2xl text-green-500" />
                    </div>
                    <p className="text-3xl font-bold text-gray-900">{callAllSubsidiary.length}</p>
                </div>
            ...
            <div className="mt-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-4 xl:grid-cols-4 gap-10">
                <div className="col-span-4 max-w-8xl rounded shadow-lg flex flex-wrap justify-center bg-blanco">
                    <ServerTableSubsidiary></ServerTableSubsidiary>
                </div>
            </div>
        </main>
    );
