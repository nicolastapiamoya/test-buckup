...
import ServerUsersTable from "@/app/components/users/ServerUsersTable";
...
export default async function Users() {
    ...
    return (
        <main className=" flex min-h-screen flex-col px-12 bg-gris">
                ...
                <div className="py-3 col-span-3 rounded overflow-hidden shadow-lg bg-blanco">
                    <div className="grid grid-cols-8">
                        ...
                        <div className="col-span-4 mt-5 sm:mt-5 md:mt-0 lg:mt-0 xl:mt-0 flex justify-start px-5">
                            <Link className="static bg-primary hover:bg-hover-primary text-white font-semibold py-3 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 flex items-center" href="/administrator/users/create" type="button">
            ...
            <div className="mt-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-4 xl:grid-cols-4 gap-10 mb-5">
                ...
                <div className="col-span-3 max-w-8xl rounded shadow-lg flex flex-wrap justify-center bg-blanco">
                    <Suspense fallback={<>Cargando Usuario...</>}>
                        <ServerUsersTable></ServerUsersTable>
                    </Suspense>
                </div>
            </div>
        </main>
