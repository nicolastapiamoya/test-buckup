...
import { usersById } from '@/app/api/auth/user/route';
import { formUpdateUser } from '@/app/actions/actions';
import { redirect } from 'next/navigation';

export default async function page({ params }) {
    const id = params.id_user;
    const users = await usersById(id)

    async function updateUser(body) {
        'use server'
        const edit = await formUpdateUser(body, id)
        if (edit) {
        ...
        <main className=" flex min-h-screen flex-col px-12 bg-gris">
                ...
                <div className="py-3 col-span-3 rounded overflow-hidden shadow-lg bg-blanco">
                    <div className="grid grid-cols-8">
                        <div className="col-span-8 sm:col-span-8 md:col-span-2 lg:col-span-2 xl:col-span-2 ml-5 mt-2">
                            <h1 className="font-bold text-2xl">Actualizar usuario</h1>
                        </div>
            ...
            <div className="mt-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-4 xl:grid-cols-4 gap-10">
                <div className="col-span-4 max-w-8xl rounded shadow-lg flex flex-wrap justify-center bg-blanco">
                    <form className="w-full max-w-3xl mt-10 mb-10" action={updateUser}>
                        {
                                    ...
                                    <div className="flex flex-wrap -mx-3 mb-6">
                                        ...
                                        <div className="w-full md:w-1/2 px-3 mx-4 sm:mx-3 md:mx-2 lg:mx-1 xl:mx-0">
                                            ...
                                            <input
                                                ...
                                                name='telephone_user'
                                                defaultValue={user.telephone_user}
                                            />
                                        </div>
                                    ...
                                    <div className="flex flex-wrap -mx-3 mb-2">
                                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0 mx-4 sm:mx-3 md:mx-2 lg:mx-1 xl:mx-0">
                                            ...
                                            <div className="relative">
                                                <select className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" name='id_role' defaultValue={user.id_role} >
                                        ...
                                        <div className="w-full md:w-1/2 px-3 mb-6 mt-0 sm:mt-0 md:mt-4 lg:mt-4 xl:mt-0 mx-4 sm:mx-3 md:mx-2 lg:mx-1 xl:mx-0">
                                            ...
                                            <div className="relative">
                                                <select className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" name='status' defaultValue={user.status}>
                        ...
                        <div className="flex justify-center">
                            <button className="shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 bg-primary w-52 hover:bg-hover-primary sm:mt-0 lg:mt-4 xl:mt-4 text-white font-bold py-2 px-10 rounded-lg focus:outline-none focus:shadow-outline flex justify-center" type="submit">
                                Actualizar
                            </button>
                        </div>
                    </form>
