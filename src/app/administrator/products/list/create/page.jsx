...
import AddListProduct from '@/app/components/products/productList/AddListProduct'
import Link from 'next/link'
import React from 'react'
import * as IconLu from "react-icons/lu";

export default function CreateListProduct() {
  return (
        ...
        <div className="py-3 col-span-3 rounded overflow-hidden shadow-lg bg-blanco">
          <div className="grid grid-cols-8">
            <div className="col-span-8 sm:col-span-8 md:col-span-2 lg:col-span-2 xl:col-span-2 ml-5 mt-2">
              <h1 className="font-bold text-2xl">Crear lista de producto</h1>
            </div>
