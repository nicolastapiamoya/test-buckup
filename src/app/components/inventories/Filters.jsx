        ...
        <>
            ...
            <div className="grid grid-cols-2 justify-between p-4">
                <div className="flex justify-start col-span-2">
                    <h1 className="ml-5 mb-3">Tipo de inventario</h1>
                </div>
                ...
                <div className="flex justify-start col-span-1">
                    <h1 className="ml-5 mt-3 text-sm">On line</h1>
                </div>
                <div className="flex justify-end col-span-1">
                    <h1 className="ml-5 mt-3 text-xs"><span className="inline-block bg-secondary text-white text-xs px-2 py-1 rounded-full">5</span></h1>
                </div>
            ...
            <div className="grid grid-cols-1 justify-between p-4">
                <div className="flex justify-start col-span-2">
                    <h1 className="ml-5 mb-3">Productos</h1>
                </div>
                ...
                <div className="flex justify-start col-span-2">
                    <h1 className="ml-5 mt-3 text-sm">Master</h1>
                </div>

                <div className="flex justify-start col-span-2">
                    <h1 className="ml-5 mt-3 text-sm">Variaciones</h1>
                </div>
            </div>
