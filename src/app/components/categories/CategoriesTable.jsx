            ...
            <table className="table-fixed mb-3 mt-5 inline-block">
                <thead>
                    <tr className="border-solid border-2">
                        ...
                        <th className="px-4 py-1 font-semibold">Categoía principal</th>
                ...
                <tbody>
                    {categories.length > 0 ? categories.map((ctg, index) => (
                        <tr key={`${ctg.id_category}-${index}`}>
                            ...
                            <td className="border px-4 py-1 text-sm">{ctg.parent_id}</td>
                            <td className="border px-4 py-1">
                                <Link href={`/administrator/categories/${ctg.id_category}`}>
